...
<div class="sidebar fixed left-0 top-0 bottom-0 w-20 bg-white transition-all duration-300 z-50 shadow-lg border-r border-gray-200 overflow-x-hidden">
    ...
    <nav class="py-4 px-2 space-y-1 flex flex-col">
        <a href="<?php echo e(route('dashboard')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('dashboard') ? 'text-purple-600' : 'text-gray-500'); ?>">
        ...
        <a href="<?php echo e(route('servers')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('servers') ? 'text-purple-600' : 'text-gray-500'); ?>">
        ...
        <a href="<?php echo e(route('databases')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('databases') ? 'text-purple-600' : 'text-gray-500'); ?>">
        ...
        <a href="<?php echo e(route('organisations')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('organisations') ? 'text-purple-600' : 'text-gray-500'); ?>">
        ...
        <a href="<?php echo e(route('users')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('users') ? 'text-purple-600' : 'text-gray-500'); ?>">
        ...
        <a href="<?php echo e(route('audit-logs')); ?>" wire:navigate 
           class="group flex items-center justify-center px-0 py-3 rounded-xl transition-all duration-200 relative <?php echo e(request()->routeIs('audit-logs') ? 'text-purple-600' : 'text-gray-500'); ?>">
    ...
    <div class="mt-auto border-t border-gray-200">
        ...
        <div class="py-3 px-3 flex items-center justify-center border-t border-gray-200">
            <span class="text-xs font-bold text-gray-400"><?php echo e($appVersion); ?></span>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\web\APPS-MONITORING\resources\views/livewire/layout/navigation.blade.php ENDPATH**/ ?>