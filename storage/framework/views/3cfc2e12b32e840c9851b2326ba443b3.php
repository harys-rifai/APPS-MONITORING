                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <tr>
                                        <td class="py-2 px-3 whitespace-nowrap">
                                            <div class="text-xs font-medium text-gray-900 truncate"><?php echo e($log->user->name ?? 'System'); ?></div>
                                        ...
                                        <td class="py-2 px-3 text-xs text-gray-500 max-w-[200px] truncate" title="<?php echo e($log->message); ?>">
                                            <?php echo e($log->message); ?>

                                        </td>
                                        <td class="py-2 px-3 text-xs text-gray-500 truncate">
                                            <?php echo e(Str::limit($log->ip_address, 15)); ?>
                                        ...
                                        <td class="py-3 px-3 text-right">
                                            <button wire:click="viewLog(<?php echo e($log->id); ?>)" class="text-indigo-600 hover:text-indigo-800 p-0.5 rounded-sm hover:bg-indigo-100" title="View details">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tailwind-pagination','data' => ['links' => $logs]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['links' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($logs)]); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showViewModal && $selectedLog): ?>
                        ...
                        <div class="bg-white rounded-xl p-6 w-full max-w-lg border border-gray-200 shadow-lg max-h-[80vh] overflow-y-auto relative z-10">
                            ...
                            <div class="space-y-4 text-sm">
                                <div>
                                    ...
                                    <p class="font-medium text-gray-800"><?php echo e($selectedLog->user->name ?? 'System'); ?></p>
                                    <p class="text-gray-500 text-xs"><?php echo e($selectedLog->user->email ?? ''); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 mb-1">Action</p>
                                    <span class="px-2 py-1 rounded text-xs font-semibold <?php echo e($selectedLog->action === 'create' ? 'bg-green-100 text-green-800' : ($selectedLog->action === 'update' ? 'bg-blue-100 text-blue-800' : 'bg-red-100 text-red-800')); ?>">
                                        <?php echo e(ucfirst($selectedLog->action)); ?>

                                    </span>
                                </div>
                                <div>
                                    <p class="text-gray-500 mb-1">Entity</p>
                                    <p class="font-medium text-gray-800"><?php echo e(ucfirst($selectedLog->entity_type)); ?> #<?php echo e($selectedLog->entity_id); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 mb-1">IP Address</p>
                                    <p class="font-medium text-gray-800"><?php echo e($selectedLog->ip_address); ?></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 mb-1">Timestamp</p>
                                    <p class="font-medium text-gray-800"><?php echo e($selectedLog->created_at->format('d M Y H:i:s')); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($selectedLog->created_at->diffForHumans()); ?></p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedLog->message): ?>
                                    <div>
                                        <p class="text-gray-500 mb-1">Details</p>
                                        <p class="font-mono text-sm bg-gray-50 p-3 rounded-lg whitespace-pre-wrap max-h-32 overflow-y-auto"><?php echo e($selectedLog->message); ?></p>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
...
<?php /**PATH F:\www\APPS-MONITORING\resources\views/livewire/audit-log-list.blade.php ENDPATH**/ ?>