...
class="bg-white px-3 py-1 border-r border-t border-b text-black no-underline hover:bg-gray-50 text-sm font-medium rounded-md"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginator->hasMorePages()): ?>
                    <a href="<?php echo e($paginator->nextPageUrl()); ?>" class="relative ml-3 inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700" rel="next" aria-label="Next Page">Next</a>
                <?php else: ?>
...
<?php /**PATH C:\laragon\www\web\APPS-MONITORING\resources\views/components/tailwind-pagination.blade.php ENDPATH**/ ?>