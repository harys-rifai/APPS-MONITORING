                    ...
                    <form wire:submit.prevent="save" @submit="loading = true">
                        <div class="space-y-2">
                            <div>
                                ...
                                <select wire:model="organisation_id" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-1.5 text-sm text-gray-800 focus:outline-none focus:border-blue-500">
